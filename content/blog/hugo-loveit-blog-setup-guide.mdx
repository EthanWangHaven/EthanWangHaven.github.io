...
```toml
baseURL = "https://EthanWangHaven.github.io/"
...
[params.author]
  name = "EthanWangHaven"
  github = "https://github.com/EthanWangHaven"
...
# 关联远端 EthanWangHaven.github.io 仓库
...
推送完成后，打开浏览器访问仓库页面 `https://github.com/EthanWangHaven/EthanWangHaven.github.io`，刷新确认所有博客文件已上传成功。
...
1. 打开仓库页面 `https://github.com/EthanWangHaven/EthanWangHaven.github.io`
2. 点击顶部 **Settings** 标签
3. 左侧菜单栏找到 **Pages**
...
```
https://EthanWangHaven.github.io
```
...
1. 打开 `https://github.com/EthanWangHaven/EthanWangHaven.github.io`
2. 点击 **Actions** 标签，确认 `Build & Deploy Hugo Blog` 工作流绿色通过
3. 访问 `https://EthanWangHaven.github.io` 确认新文章已上线
...
```powershell
cd E:\Undergraduate_materials\EthanWangHaven.github.io
