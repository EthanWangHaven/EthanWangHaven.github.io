...
![AI时代检索问题示意图](/images/Hybrid Retrieval1.png)
...
![GREP与RAG对比示意图](/images/Hybrid Retrieval2.png)

*图：GREP精确匹配与RAG语义召回的对比*
...
![行业产品路线图](/images/Hybrid Retrieval3.png)

*图：Agentic Coding Tool与Codebase Knowledge Tool两类产品路线*
...
![行业选型趋势图](/images/Hybrid Retrieval4.png)
...
![RAG架构示意图](/images/Hybrid Retrieval5.png)
...
![向量索引工作原理](/images/Hybrid Retrieval6.png)

*图：文本转换为向量并在语义空间中检索的过程*
...
![图片向量化示意图](/images/Hybrid Retrieval9.png)

*图：图片通过Embedding模型转换为向量的过程*
...
![Hybrid Retrieval架构图](/images/Hybrid Retrieval14.png)
